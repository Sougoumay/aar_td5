        ...
        <c:if test="${employe.service != null}">
            <li>
                ...
                <ul>
                    ...
                    <li>Membres :
                        <ul>
                            <c:forEach items="${employe.service.membres}" var="membre">
                ...
                <ul>
                    ...
                    <c:if test="${employe.adresse.pays != null}">
                        <li>
                            Pays
                            <ul>
                                <li>Code : ${employe.adresse.pays.codePays}</li>
                                <li>Nom : ${employe.adresse.pays.nomPays}</li>
                            </ul>
                        </li>
                    </c:if>
                </ul>
            ...
            <li>
                ...
                <ul>
                    <c:forEach items="${employe.projetsEnCours}" var="projetEnCours">
                        <li>Code : ${projetEnCours.codeProjet}</li>
                        <li>Nom : ${projetEnCours.nomProjet}</li>
                        <li>Status : ${projetEnCours.statut}</li>
                        </br>
                    </c:forEach>
                </ul>
            </li>
